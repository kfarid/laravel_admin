...
var toolbar = renderer.create('<div class="note-toolbar card-header" roles="toolbar"></div>');
...
var editable = renderer.create('<div class="note-editable card-block" contentEditable="true" roles="textbox" aria-multiline="true"></div>');
...
var dropdown = renderer.create('<div class="note-dropdown-menu dropdown-menu" roles="list"></div>', function ($node, options) {
...
var dropdownCheck = renderer.create('<div class="note-dropdown-menu dropdown-menu note-check" roles="list"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
...
var dialog = renderer.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" roles="dialog"></div>', function ($node, options) {
  if (options.fade) {
    $node.addClass('fade');
  }
